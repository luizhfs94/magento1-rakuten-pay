...
namespace RakutenPay\Resources\Factory\Request\DirectPayment\CreditCard;

/**
 * Description of Installment
 *
 * @package RakutenPay\Resources\Factory\Request\DirectPayment\CreditCard
 */
class Installment
{
    private $installment;
    ...
    public function instance(\RakutenPay\Domains\DirectPayment\CreditCard\Installment $installment)
    {
        return $installment;
    }
    ...
    {
        $installment = new \RakutenPay\Domains\DirectPayment\CreditCard\Installment();
        $installment
