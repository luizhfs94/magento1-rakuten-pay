...
namespace RakutenPay\Parsers\Transaction;

use RakutenPay\Parsers\Response\CreditorFees;
use RakutenPay\Parsers\Response\Currency;
use RakutenPay\Parsers\Response\Item;
use RakutenPay\Parsers\Response\PaymentMethod;
use RakutenPay\Parsers\Response\Sender;
use RakutenPay\Parsers\Response\Shipping;

/**
 * Class Response
 * @package RakutenPay\Parsers\Transaction
 */
class Response
{
    use Currency;
