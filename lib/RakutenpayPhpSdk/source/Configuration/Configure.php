...
namespace RakutenPay\Configuration;

use RakutenPay\Domains\AccountCredentials;
use RakutenPay\Domains\Charset;
use RakutenPay\Domains\Environment;
use RakutenPay\Domains\Log;
use RakutenPay\Resources\Responsibility;

/**
 * Class Configure
 * @package RakutenPay\Configuration
 */
class Configure
{
