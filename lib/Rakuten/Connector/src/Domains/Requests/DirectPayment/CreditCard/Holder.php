...
trait Holder
{
    ...
    /**
     * @return \Rakuten\Connector\Domains\Requests\Adapter\DirectPayment\Holder
     */
    public function setHolder()
    {
        $this->holder = InitializeObject::initialize(
            $this->holder,
            '\Rakuten\Connector\Domains\DirectPayment\CreditCard\Holder'
        );
        return new \Rakuten\Connector\Domains\Requests\Adapter\DirectPayment\Holder($this->holder);
    }
