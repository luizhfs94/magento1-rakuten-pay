...
trait Billing
{
    ...
    /**
     *
     * @return \RakutenConnector\Domains\Requests\Adapter\DirectPayment\Billing
     */
    public function setBilling()
    {
        $this->billing = InitializeObject::initialize(
            $this->billing,
            '\RakutenConnector\Domains\DirectPayment\CreditCard\Billing'
        );
        return new \RakutenConnector\Domains\Requests\Adapter\DirectPayment\Billing($this->billing);
    }
