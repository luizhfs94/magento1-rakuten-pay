...
trait Sender
{
    ...
    {
        $this->sender = InitializeObject::initialize($this->sender, '\RakutenConnector\Domains\Sender');
        return new \RakutenConnector\Domains\Requests\Adapter\Sender($this->sender);
    }
