...
namespace RakutenConnector\Resources\Factory\Shipping;

use RakutenConnector\Enum\Properties\Current;

/**
 * Class Address
 * @package RakutenConnector\Resources\Factory\Shipping
 */
class Address
{

    /**
     * @var \RakutenConnector\Domains\Shipping
     */
    private $shipping;
    ...
    /**
     * @param \RakutenConnector\Domains\Addres $address
     * @return \RakutenConnector\Domains\Shipping
     */
