...
namespace RakutenConnector\Resources\Factory\Request\DirectPayment\CreditCard;

/**
 * Class Installment
 * @package RakutenConnector\Resources\Factory\Request\DirectPayment\CreditCard
 */
class Installment
{
    private $installment;
    ...
    public function instance(\RakutenConnector\Domains\DirectPayment\CreditCard\Installment $installment)
    {
        return $installment;
    }
    ...
    {
        $installment = new \RakutenConnector\Domains\DirectPayment\CreditCard\Installment();
        $installment
