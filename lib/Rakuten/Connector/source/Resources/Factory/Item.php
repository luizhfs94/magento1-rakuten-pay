...
namespace RakutenConnector\Resources\Factory;

use RakutenConnector\Enum\Properties\Current;

/**
 * Class Item
 * @package RakutenConnector\Resources\Factory
 */
class Item
{
    /**
    ...
    /**
     * @param \RakutenConnector\Domains\Item $item
     * @return \RakutenConnector\Domains\Item
     */
    public function instance(\RakutenConnector\Domains\Item $item)
    {
        return $item;
    }
    ...
    public function withArray($array)
    {
        ...
        $item = new \RakutenConnector\Domains\Item();
