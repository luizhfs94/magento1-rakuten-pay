...
namespace RakutenConnector\Enum\Properties;

/**
 * Class Current
 * @package RakutenConnector\Enum\Properties
 */
class Current
{
     ...
     * Search initial date
     */
    const SEARCH_INITIAL_DATE = "date_from";

    /**
     * Search final date
     */
    const SEARCH_FINAL_DATE = "date_to";
     ...
     */
    const SHIPPING_ADDRESS_NAME = "shippingAddressName";

    /**
     * Shipping address name
     */
    const SHIPPING_ADDRESS_PHONE = "shippingAddressPhone";
