...
namespace RakutenConnector\Parsers\Transaction;

use RakutenConnector\Parsers\Response\CreditorFees;
use RakutenConnector\Parsers\Response\Currency;
use RakutenConnector\Parsers\Response\Item;
use RakutenConnector\Parsers\Response\PaymentMethod;
use RakutenConnector\Parsers\Response\Sender;
use RakutenConnector\Parsers\Response\Shipping;

/**
 * Class Response
 * @package RakutenConnector\Parsers\Transaction
 */
class Response
{
    use Currency;
