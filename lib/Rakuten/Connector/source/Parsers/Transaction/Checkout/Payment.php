...
namespace RakutenConnector\Parsers\Transaction\Checkout;

use RakutenConnector\Parsers\Transaction\Checkout\Installment;

/**
 * Class Payment
 * @package RakutenConnector\Parsers\Transaction\Checkout
 */
class Payment
{
    private $amount;
