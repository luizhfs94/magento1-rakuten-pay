...
class Rakuten_RakutenPay_Adminhtml_AjaxController extends Mage_Adminhtml_Controller_Action
{
    private $log;

    public function indexAction()
    {
        $this->log = Mage::helper('rakutenpay/log');
    ...
    {
        $refund = Mage::helper('rakutenpay/refund');
