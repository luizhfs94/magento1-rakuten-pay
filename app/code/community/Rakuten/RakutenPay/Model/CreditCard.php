 ...
 */
class Rakuten_RakutenPay_Model_CreditCard extends Mage_Payment_Model_Method_Abstract
{
     ...
     */
    protected $_formBlockType = 'rakuten_rakutenpay/form_creditCard';
    protected $_infoBlockType = 'rakuten_rakutenpay/info_creditCard';
/**
     * Assign block data
     * @param type $data
     * @return $this
    ...
    {
        \Rakuten\Connector\Resources\Log\Logger::info('Processing assignData in ModelCreditCard.');
    ...
    {
        \Rakuten\Connector\Resources\Log\Logger::info('Processing validate in ModelCreditCard.');
        parent::validate();
        $info = $this->getInfoInstance();
    ...
    {
        \Rakuten\Connector\Resources\Log\Logger::info('Processing getOrderPlaceRedirectUrl in ModelCreditCard.');
