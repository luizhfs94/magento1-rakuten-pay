...
/**
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing assignData in ModelCreditCard.');
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing validate in ModelCreditCard.');
        parent::validate();
        $info = $this->getInfoInstance();
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing getOrderPlaceRedirectUrl in ModelCreditCard.');
