...
class Rakuten_RakutenPay_Model_OrderAddress
{
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Constructing ModelOrderAddress.');
        $this->order = $order;
    ...
    /**
     * @return \RakutenConnector\Domains\Address
     */
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing setAddress in ModelOrderAddress.');
        $name = '';
        ...
        $response = new \RakutenConnector\Domains\Address();
    ...
    /**
     * @param $phone
     * @return \RakutenConnector\Domains\Phone
     */
    public static function formatPhone($phone)
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing formatPhone in ModelOrderAddress.');
        ...
        $response = new RakutenConnector\Domains\Phone();
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing parseStreet in ModelOrderAddress.');
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing getRegionAbbreviation in ModelOrderAddress.');
        if (!is_null($address->getRegionCode()) && strlen($address->getRegionCode()) == 2) {
            return strtoupper($address->getRegionCode());
        }

        $addressEnum = new \RakutenConnector\Enum\Address();
