...
class Rakuten_RakutenPay_Model_Boleto extends Mage_Payment_Model_Method_Abstract
{
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing assignData in ModelBoleto.');
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing validate in ModelBoleto.');
        parent::validate();
        $info = $this->getInfoInstance();
        return $this;
    }
    ...
    {
        \RakutenConnector\Resources\Log\Logger::info('Processing getOrderPlaceRedirectUrl in ModelBoleto.');
