...
use Rakuten_Connector_Helper_Data as HelperData;

class Rakuten_Connector_Helper_RakutenPay_Html extends HelperData
{
    /**
    ...
    {
        $logo = Mage::getBaseUrl('skin') . 'adminhtml/default/default/rakuten/connector/rakutenpay/images/logo.png';
